...
#define EOS_PLATFORM_RTCOPTIONS_API_002 2

/** Platform RTC options. */
EOS_STRUCT(EOS_Platform_RTCOptions002, (
...
#define EOS_PLATFORM_GETDESKTOPCROSSPLAYSTATUS_API_001 1

/**
 * Input parameters for the EOS_Platform_GetDesktopCrossplayStatus function.
 */
EOS_STRUCT(EOS_Platform_GetDesktopCrossplayStatusOptions001, (
